...
### Changed
 ...
 - Fix [#91](https://github.com/mmomtchev/node-gdal-async/issues/91), add the missing TypeScript property `data_type` to `gdal.ReadOptions` and fix the passing of the option
