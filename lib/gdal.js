...
const s57_csv_path = path.resolve(__dirname, '..', 'deps', 'libgdal', 'gdal', 'ogr', 'ogrsf_frmts', 's57', 'data')
...
if (fs.existsSync(s57_csv_path)) {
  gdal.config.set('S57_CSV', s57_csv_path)
} else {
  console.warn('S57 csv files not found in ', s57_csv_path)
}
